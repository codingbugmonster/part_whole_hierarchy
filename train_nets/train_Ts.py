...
if __name__ == "__main__":
    ...
    H = 40
    W = 40
    net1 = dae.dae(H * W, 1000).to(device)
    train_dae(net1, save_dir="../tmp_net/bar_part_net.pty", dataset_name="bars_part", H=H, W=W,
                log_iter=False, fig_dir='../tmp_img/bar_part_',lr=0.001)
    net2 = dae.dae(H * W, 1000).to(device)
    train_dae(net2, save_dir="../tmp_net/bar_whole_net.pty", dataset_name="bars_whole", H=H, W=W,
              log_iter=False, fig_dir='../tmp_img/bar_whole_',lr = 0.001)
