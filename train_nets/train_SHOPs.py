...
if __name__ == "__main__":
    ...
    H = 60
    W = 60
    net1 = dae.dae(H * W, 400).to(device)  # before 200 hiddensize
    train_dae(net1, save_dir="../tmp_net/shape_part_net4_07.pty", dataset_name="shapes_part", H=H, W=W,
                log_iter=False, fig_dir='../tmp_img/part_shapes_',lr=0.001)
    net2 = dae.dae(H * W, 400).to(device)  # before 200 hiddensize
    train_dae(net2, save_dir="../tmp_net/shape_whole_net4_07.pty", dataset_name="shapes_whole", H=H, W=W,
              log_iter=False, fig_dir='../tmp_img/whole_shapes_',lr = 0.001)
