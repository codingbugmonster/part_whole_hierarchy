...
if __name__ == "__main__":
    ...
    H = 80
    W = 80
    net1 = dae.dae(H * W, 2000).to(device)
    train_dae(net1, save_dir="../tmp_net/mnist_part_net.pty", dataset_name="mnist_part", H=H, W=W,
                log_iter=False, fig_dir='../tmp_img/mnist_part_',lr=0.001)
    net2 = dae.dae(H * W, 2000).to(device)
    train_dae(net2, save_dir="../tmp_net/mnist_whole_net.pty", dataset_name="mnist_whole", H=H, W=W,
              log_iter=False, fig_dir='../tmp_img/mnist_whole_',lr = 0.001)
