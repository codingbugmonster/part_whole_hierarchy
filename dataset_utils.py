...
def gain_dataset(data_dir, name):
    with open_dataset(data_dir, name) as f:
        ...
        train_multi_label = f["train_multi"]["groups1"][:]
        train_single_label = f["train_single"]["groups1"][:]
        test_label = f["test"]["groups1"][:]

        train_multi_label2 = f["train_multi"]["groups2"][:]
        train_single_label2 = f["train_single"]["groups2"][:]
        test_label2 = f["test"]["groups2"][:]

    return train_single_data, train_multi_data, test_data, train_single_label, train_multi_label, test_label, train_single_label2, train_multi_label2, test_label2
